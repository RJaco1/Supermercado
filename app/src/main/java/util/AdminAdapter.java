...
public class AdminAdapter extends RecyclerView.Adapter<AdminAdapter.ViewHolder> implements Filterable {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, final AdminAdapter.OnItemClickListener listener) {
            super(itemView);
    ...
    public AdminAdapter(AppCompatActivity context, int resource, List<Producto> listProd) {
    ...
    public AdminAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        AdminAdapter.ViewHolder viewHolder = new AdminAdapter.ViewHolder(view, listener);
